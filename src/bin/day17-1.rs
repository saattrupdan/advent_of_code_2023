...
// finding anyone on your way up: half of Gear Island is empty, but the half below you
// is a giant factory city!
//
...
// find the best way to get the crucible from the lava pool to the machine parts
...
// patterns, ambient temperature, and hundreds of other parameters to calculate exactly
// how much heat loss can be expected for a crucible entering any particular city
// block.
//
// For example:
//
...
// 2546548887735
// 4322674655533
// Each city block is marked by a single digit that represents the amount of heat loss
// if the crucible enters that block. The starting point, the lava pool, is the
// top-left city block; the destination, the machine parts factory, is the bottom-right
// city block. (Because you already start in the top-left block, you don't incur that
...
fn main() {
    // let data = include_str!("../../data/day17.txt");
