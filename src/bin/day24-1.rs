...
// velocities are constant and indicate exactly how far each hailstone will move in one
// nanosecond.
//
...
// area. Comparing all pairs of hailstones' future paths produces the following
// results:
//
...
// position each at least 200000000000000 and at most 400000000000000. Disregard the Z
// axis entirely.
//
...
fn main() {
    // let data = include_str!("../../data/day24.txt");
