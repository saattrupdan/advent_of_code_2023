...
// rule that matches the part being considered is applied immediately, and the part
// moves on to the destination described by the rule. (The last rule in each workflow
...
// contains four rules. If workflow ex were considering a specific part, it would
...
// parts the Elves would like you to sort. All parts begin in the workflow named in. In
// this example, the five listed parts go through the following workflows:
//
...
fn main() {
    // let data = include_str!("../../data/day19.txt");
