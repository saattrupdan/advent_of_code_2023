...
// and shiny, and many of the fallen mirrors have lodged into the ash at strange
// angles. Because the terrain is all one color, it's hard to tell where it's safe to
// walk or where you're about to run into a mirror.
//
...
//     ><
// 123456789
// In this pattern, the line of reflection is the vertical line between columns 5 and
// 6. Because the vertical line is not perfectly in the middle of the pattern, part of
// the pattern (column 1) has nowhere to reflect onto and can be ignored; every other
// column has a reflected column within the pattern and must match exactly: column 2
// matches column 9, column 3 matches 8, 4 matches 7, and 5 matches 6.
//
...
//
// Find the line of reflection in each of the patterns in your notes. What number do
// you get after summarizing all of your notes?

fn main() {
    // let data = include_str!("../../data/day13.txt");
