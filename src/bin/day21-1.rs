...
// enough sand to filter the water for Snow Island and we'll have snow again in no
// time."
//
// While you wait, one of the Elves that works with the gardener heard how good you are
// at solving problems and would like your help. He needs to get his steps in for the
// day, and so he'd like to know which garden plots he can reach with exactly his
// remaining 64 steps.
//
...
// Then, he can take one step north, south, east, or west, but only onto tiles that are
// garden plots. This would allow him to reach any of the tiles marked O:
//
// ...........
// .....###.#.
// .###.##..#.
...
// .##..##.##.
// ...........
// Then, he takes a second step. Since at this point he could be at either tile marked
// O, his second step would allow him to reach any garden plot that is one step north,
...
// .##O.##.##.
// ...........
// In this example, if the Elf's goal was to get exactly 6 more steps today, he could
// use them to reach any of 16 garden plots.
//
// However, the Elf actually needs to get 64 steps today, and the map he's handed you
// is much larger than the example map.
//
// Starting from the garden plot marked S on your map, how many garden plots could the
// Elf reach in exactly 64 steps?

fn main() {
    // let data = include_str!("../../data/day21.txt");
